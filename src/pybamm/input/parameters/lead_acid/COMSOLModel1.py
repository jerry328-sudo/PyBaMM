...
def get_parameter_values() -> dict[str, object]:
    ...
    for obsolete_key in [
        ...
        "Oxygen reference OCP vs SHE [V]",
        "Hydrogen reference OCP vs SHE [V]",
        "Negative electrode anodic transfer coefficient",
        "Negative electrode cathodic transfer coefficient",
        "Positive electrode anodic transfer coefficient",
        "Positive electrode cathodic transfer coefficient",
        "Positive oxygen anodic transfer coefficient",
        "Positive oxygen cathodic transfer coefficient",
        "Negative hydrogen anodic transfer coefficient",
        "Negative hydrogen cathodic transfer coefficient",
    ...
    values.update(
        {
            ...
            "Discharge Positive electrode exchange-current density [A.m-2]": positive_exchange_current_density,
            "Charge Positive electrode oxygen exchange-current density [A.m-2]": positive_oxygen_exchange_current_density,
            "Discharge Positive electrode oxygen exchange-current density [A.m-2]": positive_oxygen_exchange_current_density,
            "Charge Negative electrode hydrogen exchange-current density [A.m-2]": negative_hydrogen_exchange_current_density,
            "Discharge Negative electrode hydrogen exchange-current density [A.m-2]": negative_hydrogen_exchange_current_density,
            ...
            "Charge Negative electrode open-circuit potential [V]": negative_open_circuit_potential,
            "Discharge Negative electrode open-circuit potential [V]": negative_open_circuit_potential,
            "Charge Positive electrode open-circuit potential [V]": positive_open_circuit_potential,
            "Discharge Positive electrode open-circuit potential [V]": positive_open_circuit_potential,
            "Charge Oxygen reference OCP vs SHE [V]": 1.23,
            "Discharge Oxygen reference OCP vs SHE [V]": 1.23,
            "Charge Hydrogen reference OCP vs SHE [V]": 0.0,
            "Discharge Hydrogen reference OCP vs SHE [V]": 0.0,
            "Charge Positive oxygen anodic transfer coefficient": 2.0,
            "Discharge Positive oxygen anodic transfer coefficient": 2.0,
            "Charge Positive oxygen cathodic transfer coefficient": 2.0,
            "Discharge Positive oxygen cathodic transfer coefficient": 2.0,
            "Charge Negative hydrogen anodic transfer coefficient": 0.5,
            "Discharge Negative hydrogen anodic transfer coefficient": 0.5,
            "Charge Negative hydrogen cathodic transfer coefficient": 0.5,
            "Discharge Negative hydrogen cathodic transfer coefficient": 0.5,
            "Positive oxygen HSO4- stoichiometry": 0.0,
            "Negative hydrogen HSO4- stoichiometry": 0.0,
            "Charge Negative electrode anodic transfer coefficient": 1.55,
            "Discharge Negative electrode anodic transfer coefficient": 1.55,
            "Charge Negative electrode cathodic transfer coefficient": 0.45,
            "Discharge Negative electrode cathodic transfer coefficient": 0.45,
            "Charge Positive electrode anodic transfer coefficient": 1.21,
            "Discharge Positive electrode anodic transfer coefficient": 1.21,
            "Charge Positive electrode cathodic transfer coefficient": 0.79,
            "Discharge Positive electrode cathodic transfer coefficient": 0.79,
        }
    )
    return values
